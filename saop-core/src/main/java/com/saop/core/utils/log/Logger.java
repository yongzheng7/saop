...
package com.saop.core.utils.log;
...
public final class Logger {
     ...
     * 默认的日志记录为Logcat
     */
    private static LogHandler sILogger = new LogcatLogger();

    private static StringUtils.ISerializer sISerializer;
     ...
     */
    public static void setISerializer(StringUtils.ISerializer sISerializer) {
        Logger.sISerializer = sISerializer;
    }

    public static StringUtils.ISerializer getISerializer() {
        return sISerializer;
    }
